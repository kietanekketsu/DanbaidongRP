...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class DBufferCopyDepthPass : CopyDepthPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            // Check if the active depth texture is compatible with the other render targets that we'll use for the dbuffer pass.
            ...
            if (!hasCompatibleDepth)
            {
                ...
                var source = (useDepthPriming || isDeferred) ? resourceData.cameraDepth : resourceData.cameraDepthTexture;
